...
INSERT INTO TRAINING_STOREFRONT.CLASS_SESSIONS (
  ...
  (7, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JUSR'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-11-13 09:00:00-12', '2017-11-14 17:00:00-12', 'CST')
  ,(10, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JADM'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-11-15 09:00:00-12', '2017-11-15 17:00:00-12', 'CST')
  ,(13, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JCRT'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-11-16 09:00:00-12', '2017-11-17 17:00:00-12', 'CST')
  ,(19, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-CSP'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-11-27 09:00:00-12', '2017-11-30 17:00:00-12', 'PST')
  ,(20, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-CSP'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Seattle'), '2017-11-27 09:00:00-12', '2017-11-30 17:00:00-12', 'PST')
  ,(21, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-CSP'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Dallas'), '2017-11-27 09:00:00-12', '2017-11-30 17:00:00-12', 'CST')
  ,(22, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-CFD'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-12-04 09:00:00-12', '2017-12-06 17:00:00-12', 'PST')
  ,(23, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-CFD'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Minneapolis'), '2017-12-04 09:00:00-12', '2017-12-06 17:00:00-12', 'CST')
  ,(24, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-CFD'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Redwood City'), '2017-12-04 09:00:00-12', '2017-12-06 17:00:00-12', 'PST')
  ,(25, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-SBD'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-12-18 09:00:00-12', '2017-12-19 17:00:00-12', 'PST')
  ,(31, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'PIV-GFD'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-12-11 09:00:00-12', '2017-12-14 17:00:00-12', 'PST')
  ,(34, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JUSR'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-12-11 09:00:00-12', '2017-12-12 17:00:00-12', 'PST')
  ,(35, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JUSR'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Minneapolis'), '2017-12-11 09:00:00-12', '2017-12-12 17:00:00-12', 'CST')
  ,(36, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JUSR'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Redwood City'), '2017-12-11 09:00:00-12', '2017-12-12 17:00:00-12', 'PST')
  ,(37, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JADM'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-12-13 09:00:00-12', '2017-12-13 17:00:00-12', 'PST')
  ,(38, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JADM'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Minneapolis'), '2017-12-13 09:00:00-12', '2017-12-13 17:00:00-12', 'CST')
  ,(39, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JADM'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Redwood City'), '2017-12-13 09:00:00-12', '2017-12-13 17:00:00-12', 'PST')
  ,(40, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JCRT'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-12-14 09:00:00-12', '2017-12-15 17:00:00-12', 'PST')
  ,(41, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JCRT'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Minneapolis'), '2017-12-14 09:00:00-12', '2017-12-15 17:00:00-12', 'CST')
  ,(42, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'CB-JCRT'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Redwood City'), '2017-12-14 09:00:00-12', '2017-12-15 17:00:00-12', 'PST')
  ,(43, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'RH124'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Columbia'), '2017-11-13 09:00:00-12', '2017-11-17 17:00:00-12', 'EST')
  ,(44, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'RH124'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-11-13 10:30:00-12', '2017-11-17 18:30:00-12', 'EST')

  ,(45, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'RH124'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'San Diego'), '2017-11-27 07:00:00-12', '2017-12-01 15:00:00-12', 'PST')
  ,(46, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'RH124'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Denver'), '2017-11-27 10:30:00-12', '2017-12-01 17:00:00-12', 'MST')
  ,(47, (SELECT SKU_KEY FROM TRAINING_STOREFRONT.SKUS AS S WHERE S.VENDOR_SKU_CODE = 'RH124'), (SELECT ADDRESS_KEY FROM TRAINING_STOREFRONT.ADDRESSES AS A WHERE A.CITY = 'Live'), '2017-11-27 10:30:00-12', '2017-12-01 18:30:00-12', 'EST')
